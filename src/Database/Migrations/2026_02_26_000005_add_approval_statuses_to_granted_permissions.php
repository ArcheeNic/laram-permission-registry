    ...
    public function up(): void
    {
        ...
        if ($driver === 'sqlite') {
            ...
            DB::statement("
                ...
                CHECK (status IN ('awaiting_approval','pending','granting','granted','revoking','revoked','failed','partially_granted','rejected'))
            ");
        }
    }
    ...
    public function down(): void
    {
        ...
        if ($driver !== 'sqlite') {
            ...
            DB::statement("
                ALTER TABLE granted_permissions 
                ADD CONSTRAINT granted_permissions_status_check 
                CHECK (status IN ('pending','granting','granted','revoking','revoked','failed','partially_granted'))
            ");
        }
    }
};
