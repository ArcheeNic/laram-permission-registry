<div>
    <div class="mb-4 flex flex-col sm:flex-row justify-between gap-4">
        <div class="flex flex-col sm:flex-row gap-4">
            <input wire:model.live="search" type="text" placeholder="{{ __('permission-registry::Search groups') }}"
            ...
            @if($groups->count() === 0)
                <tr>
                    <td colspan="4" class="px-6 py-4 text-center text-sm text-gray-500">
                        {{ __('permission-registry::No groups found') }}
                    </td>
                </tr>
            @endif
            </tbody>
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-xl max-w-md w-full">
                <div class="px-6 py-4">
                    ...
                    <div class="mt-4 text-sm text-gray-600">
                        {{ __('permission-registry::Are you sure you want to delete this group? All permission associations will be removed.') }}
                    </div>
                </div>
